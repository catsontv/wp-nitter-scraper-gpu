...
require_once NITTER_PLUGIN_DIR . 'admin/class-admin.php';
...
function nitter_activate() {
    ...
    $database->add_log('system', 'Plugin activated - Version ' . NITTER_PLUGIN_VERSION);
}
...
require_once NITTER_PLUGIN_DIR . 'ajax/ajax-handlers.php';
